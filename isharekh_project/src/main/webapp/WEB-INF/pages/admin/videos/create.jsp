                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="box-body pad">
                            <form method="POST" action="create" modelAttribute="video">
                                <textarea id="editor1" name="des" rows="10" cols="80" placeholder="Place input description khmer">
                                    ${des_kh}
                                </textarea>
                                <div>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body pad">
                            <form method="POST" action="create" modelAttribute="video">
                                <textarea name="desEn" class="textarea" placeholder="Place input description enlish"
